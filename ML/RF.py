...
# Date: 28-05-2018
# 
# Description: 	Small script to train a Random Forest classifier to predict 
...
# Run the classifier 5 times and average the accuracy
for a in range(0, runs):
	...
	print "Prediction: " + str(clf.predict(X_test))
...
print str((sum(avgAcc) / len(avgAcc)) * 100) + "%  using Random Forest"
